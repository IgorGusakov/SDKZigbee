...
#define EMBER_AF_API_EZSP_PROTOCOL "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/util/ezsp/ezsp-protocol.h"

// API ezsp from EZSP Common plugin
#define EMBER_AF_API_EZSP "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/util/ezsp/ezsp.h"

// API green-power-common from Green Power Common plugin
#define EMBER_AF_API_GREEN_POWER_COMMON "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/green-power-common/green-power-common.h"

// API linked-list from Linked List plugin
#define EMBER_AF_API_LINKED_LIST "./developer/sdks/gecko_sdk_suite/v3.2/util/plugin/plugin-common/linked-list/linked-list.h"

// API network-creator from Network Creator plugin
#define EMBER_AF_API_NETWORK_CREATOR "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-creator/network-creator.h"

// API network-creator-security from Network Creator Security plugin
#define EMBER_AF_API_NETWORK_CREATOR_SECURITY "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/framework/plugin/network-creator-security/network-creator-security.h"
...
#define EMBER_AF_API_EZSP_SECURE "./developer/sdks/gecko_sdk_suite/v3.2/protocol/zigbee/app/util/ezsp/secure-ezsp-protocol.h"

// API crc from Unix Library plugin
#define EMBER_AF_API_CRC "./developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/micro/crc.h"

// API endian from Unix Library plugin
#define EMBER_AF_API_ENDIAN "./developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/micro/endian.h"

// API hal from Unix Library plugin
#define EMBER_AF_API_HAL "./developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/hal.h"

// API random from Unix Library plugin
#define EMBER_AF_API_RANDOM "./developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/micro/random.h"

// API system-timer from Unix Library plugin
#define EMBER_AF_API_SYSTEM_TIMER "./developer/sdks/gecko_sdk_suite/v3.2/platform/base/hal/micro/system-timer.h"
